      ...
      <div className="relative z-10">
        ...
        <main className="pt-24 pb-16 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Video container */}
            <div className="relative rounded-xl overflow-hidden border border-border bg-[#1a1625] shadow-2xl">
              <video
                ref={videoRef}
                src={videoUrl}
                muted
            ...
            <div className="text-center mt-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  ...
                  className="inline-block bg-secondary text-background px-8 py-3 rounded-md font-mono text-sm font-medium hover:bg-secondary/90 transition-colors"
                >
                  Book a Demo
                </a>
                <Link
